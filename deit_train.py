...
def main(args):
    ...
    # model = create_model("deit_tiny_patch16_224", pretrained=True, num_classes=len(class_names)) 
    # model = create_model("deit_small_patch16_224", pretrained=True, num_classes=len(class_names)) 
    model = create_model("deit_base_patch16_224", pretrained=True, num_classes=len(class_names)) 
    # model = create_model("deit_large_patch16_224", pretrained=True, num_classes=len(class_names)) 
    model.to('cuda')
